...
**Response**: Gentoo has greater median than chinstrap and adelie. we
can observe that adelie has outliers.
...
**Response**: In Boxplot we can easily find out outliers where as in
jitter plot we can not differentiate between outliers and the normal
data points.
